...
import { createPerundanganPer, updatePerundanganPer } from '../../../redux/actions/perundanganPeraturan/thunkPerundanganPer';
import { formatDateInput } from '../FormatDate/FormatDateInput';
import { toast } from 'react-toastify';

const InputPerundangPer = ({ idSelected, setIdSelected }) => {
  ...
  useEffect(() => {
    if (dataEdit) {
      setTitle('Edit Data Perundangan Peraturan');
      ...
      setTitle('Input Data Perundangan Peraturan');
...
export default InputPerundangPer;
