...
import { deleteByYear, deletePerundanganKep, getPerundanganKep } from '../../../redux/actions/perundanganKeputusan/thunkPerundanganKep';
...
const TablePengundangKep = () => {
  ...
  const isError = useSelector((state) => state.perundanganKep.error);
  const isSuccess = useSelector((state) => state.perundanganKep.deleteSuccess);
        ...
        <dialog id="modalOpsi" className="modal">
          <div className="modal-box w-3/12">
            ...
            <div className="flex justify-around mt-5">
              <Button onClick={() => ExportPengundangKep(filteredData, year)} bgColor="bg-cyan-700" hoverBgColor="hover:bg-cyan-800">
