                ...
                <div className="relative">
                  <input
                    className={`w-full sm:w-[400px] h-14 p-4 rounded block border border-gray-400 focus:outline-[#74777F] placeholder-transparent peer ${
                      formik.errors.email && formik.touched.email && 'border-red-500 focus:outline-red-500'
                    }`}
                    id="email"
                    type="email"
                    placeholder="Email"
                  ...
                  <label
                    ...
                    className={`absolute px-1 transition-all bg-white text-sm text-gray-400 left-3 -top-3 peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-placeholder-shown:text-gray-400 peer-focus:text-sm peer-focus:-top-3 peer-focus:text-slate-600  ${
                      formik.errors.email && formik.touched.email && 'text-red-500 peer-focus:text-red-500 peer-placeholder-shown:text-red-500'
                    }`}
                  >
                    Email
                  </label>
                </div>
                {formik.errors.email && formik.touched.email && <p className="mt-1 text-red-500 max-[640px]:text-sm">{formik.errors.email}</p>}
              </div>
              <div className="mb-4 w-full">
                <div className="relative">
                  <input
                    className={`w-full sm:w-[400px] h-14 p-4 pr-10 rounded block border border-gray-400 focus:outline-[#74777F] placeholder-transparent peer ${
                      formik.errors.password && formik.touched.password && 'border-red-500 focus:outline-red-500'
                    }`}
                    id="password"
                  ...
                  <label
                    htmlFor="password"
                    className={`absolute px-1 transition-all bg-white text-sm text-gray-400 left-3 -top-3 peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-placeholder-shown:text-gray-400 peer-focus:text-sm peer-focus:-top-3 peer-focus:text-slate-600  ${
                      formik.errors.password && formik.touched.password && 'text-red-500 peer-focus:text-red-500 peer-placeholder-shown:text-red-500'
                    }`}
                  >
                    Password
                  </label>
